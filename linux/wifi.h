...
#define HDATA_RATE(rate)\
	...
	(rate == DESC_RATEVHT1SS_MCS0) ? "VHTSS1MCS0" :\
	(rate == DESC_RATEVHT1SS_MCS1) ? "VHTSS1MCS1" :\
	(rate == DESC_RATEVHT1SS_MCS2) ? "VHTSS1MCS2" :\
	(rate == DESC_RATEVHT1SS_MCS3) ? "VHTSS1MCS3" :\
	(rate == DESC_RATEVHT1SS_MCS4) ? "VHTSS1MCS4" :\
	(rate == DESC_RATEVHT1SS_MCS5) ? "VHTSS1MCS5" :\
	(rate == DESC_RATEVHT1SS_MCS6) ? "VHTSS1MCS6" :\
	(rate == DESC_RATEVHT1SS_MCS7) ? "VHTSS1MCS7" :\
	(rate == DESC_RATEVHT1SS_MCS8) ? "VHTSS1MCS8" :\
	(rate == DESC_RATEVHT1SS_MCS9) ? "VHTSS1MCS9" :\
	(rate == DESC_RATEVHT2SS_MCS0) ? "VHTSS2MCS0" :\
	(rate == DESC_RATEVHT2SS_MCS1) ? "VHTSS2MCS1" :\
	(rate == DESC_RATEVHT2SS_MCS2) ? "VHTSS2MCS2" :\
	(rate == DESC_RATEVHT2SS_MCS3) ? "VHTSS2MCS3" :\
	(rate == DESC_RATEVHT2SS_MCS4) ? "VHTSS2MCS4" :\
	(rate == DESC_RATEVHT2SS_MCS5) ? "VHTSS2MCS5" :\
	(rate == DESC_RATEVHT2SS_MCS6) ? "VHTSS2MCS6" :\
	(rate == DESC_RATEVHT2SS_MCS7) ? "VHTSS2MCS7" :\
	(rate == DESC_RATEVHT2SS_MCS8) ? "VHTSS2MCS8" :\
	(rate == DESC_RATEVHT2SS_MCS9) ? "VHTSS2MCS9" :\
	(rate == DESC_RATEVHT3SS_MCS0) ? "VHTSS3MCS0" :\
	(rate == DESC_RATEVHT3SS_MCS1) ? "VHTSS3MCS1" :\
	(rate == DESC_RATEVHT3SS_MCS2) ? "VHTSS3MCS2" :\
	(rate == DESC_RATEVHT3SS_MCS3) ? "VHTSS3MCS3" :\
	(rate == DESC_RATEVHT3SS_MCS4) ? "VHTSS3MCS4" :\
	(rate == DESC_RATEVHT3SS_MCS5) ? "VHTSS3MCS5" :\
	(rate == DESC_RATEVHT3SS_MCS6) ? "VHTSS3MCS6" :\
	(rate == DESC_RATEVHT3SS_MCS7) ? "VHTSS3MCS7" :\
	(rate == DESC_RATEVHT3SS_MCS8) ? "VHTSS3MCS8" :\
	(rate == DESC_RATEVHT3SS_MCS9) ? "VHTSS3MCS9" : "UNKNOWN"
